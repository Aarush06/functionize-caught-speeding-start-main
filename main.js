...
function btnClicked() {
  ...
  document.getElementById("d1-ticket").innerHTML = ticketAmount(
    d1Speed,
    d1Limit
  );
  document.getElementById("d2-ticket").innerHTML = ticketAmount(
    d2Speed,
    d2Limit
  );
  document.getElementById("d3-ticket").innerHTML = ticketAmount(
    d3Speed,
    d3Limit
  );
}
